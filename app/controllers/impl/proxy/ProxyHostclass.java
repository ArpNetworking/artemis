...
public class ProxyHostclass extends ArtemisProxy implements Hostclass {
    /**
     * Public constructor.
     *
     ...
     */
    @Inject
    public ProxyHostclass(@Named("ArtemisProxyBaseUrl") final String baseURL, final WSClient client) {
